...
myVariableName = "Reverse Reverse!"
...
function reverseCharacters(text){
    ...
    if (typeof(text) === "string"){
        ...
        newText = Number(String(text).split("").reverse().join(""));
    }
...
let arrayTest4 = [123, 8897, 42, 1138, 8675309]
